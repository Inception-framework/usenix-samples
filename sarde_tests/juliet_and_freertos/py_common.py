...
def run_commands(commands, use_shell=False, stdout=False, stderr=False):
	...
	if stdout and stderr:
		...
		subprocess.check_call(commands, shell=use_shell, stderr=sys.stderr, stdout=FNULL)
	...
	# print("[" + time.ctime(time_ended) + "] Finished command: \"" + " ".join(commands) + "\"")

	# elapsed_seconds = time_ended-time_started
	# print_with_timestamp("Command \"" + " ".join(commands) + "\" took " + str(elapsed_seconds) + " seconds to complete.")
